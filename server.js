...
const db = mysql.createConnection({
  host: "bfuoo1x5rxo8kfaykryt-mysql.services.clever-cloud.com",
  user: "uo9oqcn6mxsjgrtq",
  password: "gsPsSsRuIa9caVgxJSP1",
  database: "bfuoo1x5rxo8kfaykryt",
});
...
//         req.body.projectID
//     ]
//     const sql = `insert into categorymaster ('categoryName','categoryDescription','projectID') values ${val}`;
